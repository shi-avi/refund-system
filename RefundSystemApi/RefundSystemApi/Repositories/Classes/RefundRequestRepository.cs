...
//            .Set<RefundCalculationResultDto>()
//            .FromSqlRaw(
//                "EXEC sp_CalculateRefund @RequestId = {0}, @ClerkDecision = {1}",
//                requestId, clerkDecision)
//            .AsNoTracking()
//            .FirstOrDefaultAsync();

//            return result;
//        }
//        public async Task<List<RefundRequest>> GetCitizenRequestsAsync(int citizenId)
//        {
//            return await _context.RefundRequests
